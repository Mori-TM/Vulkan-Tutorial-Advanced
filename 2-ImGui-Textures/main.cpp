...
//	VkSampler textureSampler;
	...
	//   createTextureSampler();
		...
		Texture1.Load("textures/arnold.jpg");
	...
	void createGraphicsPipeline() {
		...
		VkDescriptorSetLayout descriptorSetLayouts[] = { uniformDescriptorSetLayout, textureDescriptorSetLayout };
	...
	void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
		...
		//	ImGui::ShowDemoWindow();
			...
			ImGui::Begin("Window");
			{
				...
				ImGui::Image(&Texture.descriptorSet, Size);
				ImGui::Image(&Texture1.descriptorSet, Size);
			}
			ImGui::End();
